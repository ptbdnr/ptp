...
import ModalPreferences from '@/components/modal-preferences/ModalPreferences';
...
export default function Page() {
  ...
  const handleSavePreferences = (preferences: Array<string>) => {
    // Update your profile with the new preferences
    setProfile({
      ...profile,
